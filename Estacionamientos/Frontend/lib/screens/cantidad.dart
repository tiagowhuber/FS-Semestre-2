...
class Cantidad extends StatefulWidget {
  const Cantidad({Key? key, required this.nombre, required this.ubicacion, required this.isHandicapped})
      : super(key: key);
  final String nombre;
...
class HandicapScreen extends StatefulWidget {
  @override
  _HandicapScreenState createState() => _HandicapScreenState();
}

class _HandicapScreenState extends State<HandicapScreen> {
  bool isSpaceFree = true; // Puedes ajustar esto según la lógica de tu aplicación
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: Colors.blue, // Color de fondo para la pantalla de handicap
      appBar: AppBar(
        title: Text('Handicap Screen'),
        backgroundColor: Colors.orange, // Color de fondo para la barra de navegación
      ),
      body: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
